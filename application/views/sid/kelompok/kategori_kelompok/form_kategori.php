      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box box-primary">
            ...
            <form action="<?= site_url('data_kelompok/kategori_form'); ?>" method="post" class="form-horizontal" autocomplete="off">
              <div class="box-body">
                 <div class="form-group">
                    <label for="kategori_kelompok" class="col-sm-4">Kategori Kelompok</label>
                    <div class="col-sm-6">
                      <input type="text" name="kategori_kelompok" id="kategori_kelompok" class="form-control input-sm" placeholder="Ketegori Kelompok">
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      <textarea name="deskripsi_kategori" class="form-control input-sm" placeholder="Deskripsi Kategori"></textarea>
                    </div>
                  </div>
