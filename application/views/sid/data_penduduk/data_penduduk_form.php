<div class="content-wrapper">
  ...
  <section class="content">
  	<form class="validation-form" action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" onreset=""autocomplete="off" data-parsley-validate="" novalidate>
  	<div class="row">
  		<div class="col-md-3">
  		...
  		<div class="col-md-9">
            ...
            <div class="col-sm-4">
             ...
             <div class="col-sm-12">
                <div class="form-group subtitle_head">
                    <label class="text-right"><strong>NOMOR IDENTITAS :</strong></label>
                </div>
            </div>

            <div class="col-sm-6">
                <div class="form-group">
                    <label id="form-label-nik">NIK</label>&nbsp;
            ...
            <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="no_kk" id="no_kk" class="form-control input-sm" value="<?= $no_kk; ?>" placeholder="Nomor KK" data-parsley-minlength="16" data-parsley-maxlength="16" data-parsley-minlength-message="Nomor KK harus bilangan 16 digit" data-parsley-maxlength-message="Nomor KK harus bilangan 16 digit" data-parsley-trigger="keyup" data-parsley-validation-threshold="2" data-parsley-required-message="Kolom ini diperlukan." required>
            ...
            <div class="col-sm-4">
                <div class="form-group">
                <label>Dusun</label>
                 <select name="dusun_id" class="form-control select-filter2" style="width: 100%;" data-parsley-required-message="Kolom ini diperlukan." required>
                    <option value="<?= $dusun_id; ?>">Pilih Dusun</option> 
                        <?php foreach($penduduk_wilayah as $row) : ?>
                            <option value="<?= $row['id']; ?>" <?=($dusun_id==$row['id'])?'selected="selected"':''?>><?= $row['nama_dusun']; ?></option>
                        <?php endforeach; ?>
                    </select>
                    <span class="help-block"> <?php echo form_error('dusun_id') ?></span>
                </div>
            </div>
            ...
            <div class="col-sm-3">
                <div class="form-group">
                  <label>RT</label>
                  <input type="text" class="form-control input-sm" value="" placeholder="RT">
                </div>
            </div>
            ...
            <div class="col-sm-3">
                <div class="form-group">
                  <label>RW</label>
                  <input type="text" class="form-control input-sm" value="" placeholder="RW">
                </div>
            </div>
