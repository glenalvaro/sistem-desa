         ...
         <div class="col-md-9">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li class="active"><a href="#peta_app" data-toggle="tab">Peta</a></li>
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane active" id="peta_app">
                <div class="form-group">
                    <label>Peta :</label>
                     <br>
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    <label>Icon :</label>&nbsp;<a href="<?= base_url('assets/img/icon/') . $st['icon_peta']; ?>" target="_blank"><?= $st['icon_peta']; ?></a>
                     <div class="custom-file">
