      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box box-primary">
            ...
            <form id="validasi" action="<?= base_url('inventaris/tambah_data'); ?>" method="post" autocomplete="off" enctype="multipart/form-data">
              <div class="box-body">
                  <div class="form-group">
                <label>Jenis Barang</label>
                     <input type="text" name="jenis_barang" class="input-sm form-control required" placeholder="Nama kegiatan">
               </div>
               ...
               <label>Kode Barang</label>
                    <div class="input-group input-group-sm date">
                        ...
                        <input class="form-control input-sm pull-right required" name="kode_barang" type="text">
                    </div>
                </div>

               <div class="form-group">
               <label>Identitas Barang</label>
                   <input type="text" name="identitas_barang" class="input-sm form-control required">
                </div>
               ...
               <div class="row">
                    ...
                    <label>APB Desa/Kelurahan :</label>
                        <input type="text" name="apb_desa" class="input-sm form-control required" placeholder="Rp.">
                    </div>
                    <div class="col-md-4">
                    <label>Perolehan Lain :</label>
                        <input type="text" name="perolehan_lain" class="input-sm form-control required" placeholder="Rp.">
                    </div>
                    <div class="col-md-4">
                    <label>Kekayaan Asli Desa/Kelurahan :</label>
                         <input type="text" name="kekayaan_desa" class="input-sm form-control required" placeholder="Rp.">
                    </div>
                </div>
               ...
               <label>Tanggal Perolehan/Pembelian</label>
                   <input type="text" name="tgl_perolehan" id="tgl_1" class="input-sm form-control required">
                </div>

               <div class="form-group">
               <label>Keterangan</label>
                  <textarea class="input-sm form-control required" name="keterangan"></textarea>
                </div>
