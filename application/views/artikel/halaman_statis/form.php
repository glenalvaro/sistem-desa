      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box box-primary">
            ...
            <form id="mainform" action="<?= base_url('halaman_statis/tambah_data'); ?>" method="post" autocomplete="off" enctype="multipart/form-data">
              <div class="box-body">
                 <div class="form-group">
                    <label for="judul_dokumen">Judul Artikel</label>
                      <input type="hidden" name="user" value="<?= $user['name']; ?>">
                      <input type="text" name="judul" id="judul" class="form-control input-sm required" placeholder="Judul Artikel">
                  </div>

                   <div class="form-group">
                    <label for="file" >Isi Artikel</label>
                  		 <textarea class="form-control input-sm required" name="isi" id="editor-text" placeholder="Isi"></textarea>
                  </div>
