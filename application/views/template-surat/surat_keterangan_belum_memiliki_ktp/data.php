...
<p style="text-align: justify; text-indent: 30px; font-size:10pt;">Orang tersebut di atas adalah benar-benar warga kami yang bertempat tinggal di <?= set_ucwords($alamat_sekarang); ?> <?= set_ucwords($sebutan_desa); ?> <?= set_ucwords($nama_desa); ?>, dan berdasarkan pengamatan kami benar bahwa yang bersangkutan belum memiliki Kartu Tanda Penduduk (KTP). Surat keterangan ini diberikan sebagai bukti identitas diri pengganti sementara Kartu Tanda Penduduk (KTP) yang saat ini masih dalam proses pembuatan.</p>
<p style="text-align: justify; font-size:10pt;">
