...
<p style="text-align: justify; text-indent: 30px; font-size:10pt;">Orang tersebut di atas adalah benar-benar warga kami yang bertempat tinggal di <?= set_ucwords($alamat_sekarang); ?> <?= set_ucwords($sebutan_desa); ?> <?= set_ucwords($nama_desa); ?> dan melakukan izin berpergian dengan keperluan <strong><?= strtoupper($keperluan); ?></strong>. Surat keterangan ini berlaku mulai <strong><?= strtoupper($berlaku_mulai); ?></strong> s/d <strong><?= strtoupper($berlaku_sampai); ?></strong>.</p>
