...
<p style="text-align: justify; text-indent: 30px; font-size:10pt;">Orang tersebut di atas adalah benar-benar warga kami yang bertempat tinggal di <?= set_ucwords($alamat_sekarang); ?> <?= set_ucwords($sebutan_desa); ?> <?= set_ucwords($nama_desa); ?>, Menerangkan bahwa yang bersangkutan diatas
benar batal Pindah ke alamat di bawah ini :
</p>
<p style="text-align: center; font-size: 11pt;"><b>-------------------- <?= set_ucwords($alamat_tujuan); ?> --------------------,</b></p>
<p style="text-align: justify; font-size:10pt;">
