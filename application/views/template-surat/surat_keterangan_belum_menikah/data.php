...
<p style="text-align: justify; text-indent: 30px; font-size:10pt;">Orang tersebut di atas adalah benar-benar warga kami yang bertempat tinggal di <?= set_ucwords($alamat_sekarang); ?> <?= set_ucwords($sebutan_desa); ?> <?= set_ucwords($nama_desa); ?> dan Benar bahwa yang bersangkutan belum pernah menikah.</p>
<p style="text-align: justify; font-size:10pt;">
